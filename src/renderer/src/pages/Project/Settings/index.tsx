...
const Settings: React.FC = (): JSX.Element => {
  ...
  // Get the terminal toggle flag from Outlet context (provided by MainTemplate)
  ...
  return (
    <>
              ...
              <div className="border border-gray-300 rounded-lg overflow-hidden w-[60vw] mx-auto">
                <details className="border-b border-gray-300 p-4">
                  ...
                  <div className="pt-2">
                    ...
                    />
                    <div className="mt-4">
                      <Button onClick={handleMobileSettingsUpdateClick} type="primary" disabled={isUpdatingMobile}>
      ...
      {showTerminal && (
        <div className="-mt-10 flex flex-col w-screen p-7">
          <Terminal />
        </div>
      )}
    </>
