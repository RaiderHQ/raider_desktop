...
const Logo: React.FC<LogoProps> = ({ size = 48 }) => (
  ...
  >
    ...
    <line x1="205" y1="230" x2="168" y2="155" stroke="#f5e680" strokeWidth="1" opacity="0.4" />
    ...
    <line x1="475" y1="230" x2="512" y2="155" stroke="#f5e680" strokeWidth="1" opacity="0.4" />
    ...
    <rect
      ...
      opacity="0.4"
    />
    <g fill="#888" opacity="0.6">
      <circle cx="255" cy="338" r="3" />
      <circle cx="285" cy="338" r="3" />
      <circle cx="315" cy="338" r="3" />
      <circle cx="345" cy="338" r="3" />
      <circle cx="375" cy="338" r="3" />
      <circle cx="405" cy="338" r="3" />
    </g>
    <g fill="#bbb" opacity="0.3">
      <circle cx="254" cy="337" r="1.3" />
      <circle cx="284" cy="337" r="1.3" />
      <circle cx="314" cy="337" r="1.3" />
      <circle cx="344" cy="337" r="1.3" />
      <circle cx="374" cy="337" r="1.3" />
      <circle cx="404" cy="337" r="1.3" />
    </g>
    {/* CROWN FACETS */}
    ...
    {/* Crown highlight */}
    <line x1="280" y1="200" x2="340" y2="140" stroke="#ff9db0" strokeWidth="1" opacity="0.3" />
    <line x1="340" y1="140" x2="400" y2="200" stroke="#ff9db0" strokeWidth="1" opacity="0.2" />
    {/* EYES */}
    <ellipse cx="300" cy="308" rx="12" ry="8" fill="#1a0a10" />
    <circle cx="296" cy="305" r="2" fill="#fff" opacity="0.6" />
    <ellipse cx="380" cy="308" rx="12" ry="8" fill="#1a0a10" />
    <circle cx="376" cy="305" r="2" fill="#fff" opacity="0.6" />
  </svg>
)
